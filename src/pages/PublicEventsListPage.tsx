        ...
        {!user ? (
          ...
          <>
            ...
            <div className="flex font-semibold text-gray-600">
              <Link className="w-25 text-sm font-semibold text-gray-600 mt-1 hover:text-gray-900" to="/events">
               My Events
              </Link>
              <Link
                className="w-30 text-sm font-semibold text-red-500 text-[12px] mt-1 hover:text-red-700"
                onClick={() => logout()}
                to="/login"
              >
                [Log Out]
